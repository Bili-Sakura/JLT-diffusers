...
class VisionRotaryEmbeddingFast(nn.Module):
    ...
    def forward(self, t):
        # Cast freqs to t's dtype to preserve bf16/fp16 end-to-end; otherwise
        # fp32 buffers would upcast q/k to fp32 and break flash_attn.cute.
        fc = self.freqs_cos.to(t.dtype)
        fs = self.freqs_sin.to(t.dtype)
